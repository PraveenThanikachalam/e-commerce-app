...
import { signIn, authConfigManager } from "@hono/auth-js/react";

authConfigManager.setConfig({
  basePath: "/api/auth",
  baseUrl: "http://localhost:8787", // Match this to the backend URL and port
});
        ...
        {isMenuOpen && (
          ...
          >
            {Links.map((item, idx) => (
              ...
              >
                <a
                  className={`ui-py-4 ui-text-[20px] ui-tracking-widest ui-transition-colors ui-duration-300 ${
                    pathName === item.href
                      ? "ui-text-orange-400"
