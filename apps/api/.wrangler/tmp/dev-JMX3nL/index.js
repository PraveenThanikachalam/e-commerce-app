...
// .wrangler/tmp/bundle-PyCSDd/checked-fetch.js
...
var HomepageContentValidation = z.object({
...
async function handleLoginOrRegister(sessionToken, _profile, _account, options) {
  ...
  const { createUser: createUser2, updateUser: updateUser2, getUser, getUserByAccount, getUserByEmail, linkAccount, createSession, getSessionAndUser, deleteSession } = adapter;
  let session2 = null;
  let user = null;
  let isNewUser = false;
...
var isUserAlreadyExists = /* @__PURE__ */ __name(async (db, email) => {
  try {
...
// .wrangler/tmp/bundle-PyCSDd/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-PyCSDd/middleware-loader.entry.ts
