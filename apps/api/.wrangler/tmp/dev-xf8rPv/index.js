...
// .wrangler/tmp/bundle-FUtKu2/checked-fetch.js
...
var Xi = I((ml, dr) => {
  "use strict";
  p();
  var yl = (sr(), O(ir)), Ji = (ar(), O(or2)), mt = Zi();
...
var CreateUserValidation = z.object({
  name: z.string(),
...
var DescriptionObject = z.object({
  desp1: z.string(),
  desp2: z.string(),
  desp3: z.string()
});
var ImageObject = z.object({
...
var AddProductValidation = z.object({
  title: z.string(),
  brand: z.string(),
  price: z.string(),
...
// .wrangler/tmp/bundle-FUtKu2/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-FUtKu2/middleware-loader.entry.ts
