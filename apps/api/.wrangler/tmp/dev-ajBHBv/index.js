...
// .wrangler/tmp/bundle-ik50Jo/checked-fetch.js
...
var AllObject = z2.object({
  image_url: z2.string().url(),
  image_alt: z2.string()
});
var HomepageContentValidation = z2.object({
  popular_categories: z2.array(AllObject),
  recent_deals: AllObject,
  popular_products: z2.array(AllObject),
  slides: z2.array(AllObject),
  popular_with_men: z2.array(AllObject),
  popular_with_women: z2.array(AllObject)
});
...
HomepageRouter.post("add-data", checkAdmin_default, AddHomePageContents);
...
app.use("/api/*", async (c3, next) => {
  if (c3.req.path.startsWith("/api/homepage")) {
    return next();
  }
...
// .wrangler/tmp/bundle-ik50Jo/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-ik50Jo/middleware-loader.entry.ts
