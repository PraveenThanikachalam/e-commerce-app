...
// .wrangler/tmp/bundle-UZDyEZ/checked-fetch.js
...
app.use(
  initAuthConfig((c3) => ({
    basePath: "/api/auth",
    // This matches the base path for authentication routes
...
app.use("/api/protected", async (c3) => {
  ...
  console.log("Context Keys and Values:", c3.req.raw);
  return c3.json(authInfo, 200);
});
app.notFound((c3) => {
...
// .wrangler/tmp/bundle-UZDyEZ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-UZDyEZ/middleware-loader.entry.ts
