...
// .wrangler/tmp/bundle-c0pBxo/checked-fetch.js
...
var z = /* @__PURE__ */ __name((r3, e2) => () => (r3 && (e2 = r3(r3 = 0)), e2), "z");
...
var CheckAdmin = /* @__PURE__ */ __name(async (c3, next) => {
  ...
  try {
    ...
    if (user[0].role !== "ADMIN")
      return c3.json({ error: "You are not an admin" }, 403);
    await next();
  } catch (error) {
...
var CredValidation = z2.object({
  email: z2.string(),
  userName: z2.string()
});
var CreateUserValidation = z2.object({
  name: z2.string(),
  ...
  role: z2.string(),
  provider: z2.string(),
  mobileNumber: z2.number()
});
var DescriptionObject = z2.object({
  desp1: z2.string(),
  desp2: z2.string(),
  desp3: z2.string()
});
var ImageObject = z2.object({
  image_url: z2.string().url(),
  image_alt: z2.string()
});
var HomepageContentValidation = z2.object({
  popular_categories: z2.array(ImageObject),
  recent_deals: ImageObject,
  popular_products: z2.array(ImageObject),
  slides: z2.array(ImageObject),
  popular_with_men: z2.array(ImageObject),
  popular_with_women: z2.array(ImageObject)
});
var UpdateUserVlidation = z2.object({
  email: z2.string().email(),
  name: z2.string().optional(),
  avatar: z2.string().optional(),
  mobileNumber: z2.number().optional()
});
var AddProductValidation = z2.object({
  title: z2.string(),
  brand: z2.string(),
  price: z2.string(),
  description: z2.array(DescriptionObject),
  image_alt: z2.array(ImageObject)
});
...
HomepageRouter.post("add-data", verifyAuth(), checkAdmin_default, AddHomePageContents);
...
ProductRouter.post("add-product", verifyAuth(), checkAdmin_default, AddProduct);
...
app.use("/api/*", async (c3, next) => {
  if (c3.req.path.startsWith("/api/homepage") || c3.req.path.startsWith("/api/product")) {
    return next();
  }
  return verifyAuth()(c3, next);
});
...
// .wrangler/tmp/bundle-c0pBxo/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-c0pBxo/middleware-loader.entry.ts
